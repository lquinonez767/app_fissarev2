...
public class NotificacionFAC {
    ...
    props.put("mail.smtp.port", "587");
        ...
        try {
              ...
              message.setFrom(new InternetAddress(origen)); //Remetente

              message.setRecipients(Message.RecipientType.TO,
                                InternetAddress.parse(destino)); //Destinat�rio(s)
...
public static void main (String[]args) 
{
   ...
   for (int i=0;i<40;i++)
   {
     nf.enviarEmail("telefonia@graiman.com", "Grupoindustrialpena.", "aquevedo@graiman.com", "Clave para llamadas FAC", "Su c�digo para realizar llamadas es 12345");
   }
}
